...
export default function ProblemDetailPage({ params }: { params: { problemId: string } }) {
    ...
    const { problems, submissions, users, currentUser, addSubmission } = useDataContext();
    ...
    if (!problem) {
        return (
            <div className="container mx-auto px-4 py-8 text-center">
                <p className="text-red-500">Lỗi: Không tìm thấy bài tập.</p>
                <button onClick={() => router.back()} className="mt-4 text-blue-600 font-semibold hover:underline">
                    &larr; Quay lại
                </button>
            </div>
        );
