...
interface AllSubmissionsPageProps {
...
const AllSubmissionsPage: React.FC<AllSubmissionsPageProps> = ({ submissions, users, problems, onSelectSubmission }) => {
                                    ...
                                    {displayedSubmissions.map(sub => {
                                        ...
                                        return (
                                            <tr key={sub.id} onClick={() => onSelectSubmission(sub.id)} className={trClickableClass}>
                                                ...
                                                <td className={`${tdClass} font-bold text-blue-600`}>{sub.feedback.totalScore.toFixed(2)}</td>
