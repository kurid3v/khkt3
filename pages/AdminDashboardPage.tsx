...
interface AdminDashboardPageProps {
    ...
    onUpdateUserRole: (userId: string, role: 'student' | 'teacher' | 'admin') => void;
    onBack: () => void;
}
...
const AdminDashboardPage: React.FC<AdminDashboardPageProps> = ({ users, problems, submissions, onSelectProblem, onSelectSubmission, onEditProblem, onUpdateUserRole, onBack }) => {
                                ...
                                <table className="w-full min-w-max">
                                    ...
                                    <tbody>
                                        {displayedProblems.map(problem => {
                                            ...
                                            return (
                                                <tr key={problem.id} onClick={() => onSelectProblem(problem.id)} className={trClickableClass}>
                                ...
                                <table className="w-full min-w-max">
                                    ...
                                    <tbody>
                                        {displayedSubmissions.map(sub => {
                                            ...
                                            return (
                                                <tr key={sub.id} onClick={() => onSelectSubmission(sub.id)} className={trClickableClass}>
