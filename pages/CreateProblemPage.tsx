...
interface CreateProblemPageProps {
  examId?: string; // Optional: To associate the problem with an exam
  onAddProblem: (
    title: string, 
    prompt: string,
    rawRubric: string,
...
const CreateProblemPage: React.FC<CreateProblemPageProps> = ({ examId, onAddProblem, onCancel }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setError('');
    onAddProblem(title, prompt, rawRubric, rubricItems, Number(customMaxScore), isRubricHidden, examId);
  };
