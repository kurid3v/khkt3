...
import type { Problem, RubricItem } from '../types';
...
const EditProblemPage: React.FC<EditProblemPageProps> = ({ problem, onUpdateProblem, onCancel }) => {
  ...
  const [customMaxScore, setCustomMaxScore] = useState<string>(String(problem.customMaxScore || '10'));
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onUpdateProblem(updatedProblemData);
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <h1 className="text-4xl font-bold text-slate-900 mb-8">Chỉnh sửa bài tập</h1>
